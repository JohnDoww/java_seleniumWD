...
public class SearchPageMethods extends BasePageMethods {
    ...
    public String addBuCarToFavorites(){
        ...
        wait.until(
                ExpectedConditions.elementToBeClickable(searchPageElements.getUsedCarsList())
        );
//        searchPageElements.getUsedCarsList().click();
        driver.navigate().refresh();
        ...
        wait.until(
                ExpectedConditions.elementToBeClickable(searchPageElements.getFirstCarToFavorites())
        );
